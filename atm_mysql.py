...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        credits=tk.Label(bottom_frame,text='Created and Develped by Arun ,Babu and Jenita',font=('orbitron',15)).pack()
